...
Given('I am on SignIn page and enter the credentials for {string}', async function (detailsType) {
  switch (detailsType.toLowerCase()) {
    case 'businessdetails':
      await this.page.goto(`${BASE_URL}/`)
      await this.page.locator("//a[normalize-space()='Sign in']").waitFor({ state: 'visible' })
    ...
    case 'personaldetails':
      ...
      await this.page.locator("//input[@id='password']").fill('Password456')
      await this.page.locator("//button[@id='next']").click()
      await this.page.locator("//a[normalize-space()='View and update your personal details']").waitFor({ state: 'visible' })
      await this.page.locator("//a[normalize-space()='View and update your personal details']").click()
      break
...
Given('I am on SignIn page and enter the credentials for {string} with {string}', async function (businessdetails, permission) {
  businessdetails = businessdetails?.toLowerCase()
  permission = permission?.toLowerCase()

  switch (true) {
    case businessdetails === 'businessdetails' && permission === 'amendpermission':
      await this.page.goto(`${BASE_URL}/`)
      ...
      await this.page.locator("//input[@id='password']").fill('Password456')
      await this.page.locator("//button[@id='next']").click()
      await this.page.locator('//label[normalize-space()="Joseph Heap Property Limited - SBI 107176577"]').click()
      await this.page.locator("//button[@id='continueReplacement']").click()
      await this.page.locator("//a[normalize-space()='View and update your business details']").click()
      await this.page.waitForTimeout(3000)
      break

    case businessdetails === 'businessdetails' && permission === 'viewpermission':
      await this.page.goto(`${BASE_URL}/`)
      await this.page.waitForTimeout(3000)
      await this.page.locator("//a[normalize-space()='Sign in']").click()
      ...
      await this.page.locator("//input[@id='password']").fill('Password456')
      await this.page.locator("//button[@id='next']").click()
      await this.page.locator("label:has-text('Chefnalls - SBI 113912887')").click()
      await this.page.locator('#continueReplacement').click()
      await this.page.locator("//a[normalize-space()='View your Business details']").click()
      await this.page.waitForTimeout(3000)
      break

    default:
      throw new Error(`Unknown credentials combination: ${businessdetails} / ${permission}`)
  }
})
...
Then('Verfiy updated phone details on the ViewAndUpdateYourBusinessType page are been displayed correctly', async function () {
  const actPhNum = await this.page
    .locator('//dt[normalize-space()="Business phone numbers"]/following-sibling::dd[1]/div[1]/span')
    .textContent()
...
Then('Verfiy Updated email details on the ChangeYourBusinessType page are been displayed correctly', async function () {
  const actEmail = await this.page
    .locator("//dt[normalize-space()='Business email address']/following-sibling::dd[1]")
    .innerText()
...
Then('Verfiy Updated Business Name details on the ChangeYourBusinessType page are been displayed correctly', async function () {
  const actBusinessName = await this.page
    .locator("//dt[normalize-space()='Business name']/following-sibling::dd[1]")
    .innerText()
...
Then('Verify Success Updated message is displayed for {string} on the page ViewAndUpdateYourBusinessType', async function (updatedMsgType) {
  switch (updatedMsgType.toLowerCase()) {
    case 'businessphonenumbers': {
      const msg = await this.page.locator("//div[@class='govuk-notification-banner__content']").innerText()
    ...
    case 'no': {
      const banner = this.page.locator("//div[@class='govuk-notification-banner__content']")
...
When('I update Business Address', async function () {
  await this.page.locator("//a[normalize-space()='Enter address manually']").click()
...
When('I click signOut link on the {string} page', async function (signOutPage) {
  switch (signOutPage.toLowerCase()) {
    ...
    case 'whatareyourbusinessphonemembers':
      await this.page.getByRole('link', { name: 'Change Business telephone numbers' }).click()
      await this.page.locator("//a[normalize-space()='Sign out']").click()
      break
...
Given('I sign In on the first tab', async function () {
  ...
  await this.page1.locator("//a[normalize-space()='Sign in']").waitFor({ state: 'visible' })
...
When('I open another tab with the same session', async function () {
  ...
  await this.page2.locator("//a[normalize-space()='Sign in']").waitFor({ state: 'visible' })
...
Given('I update Business Name and click the Change link in CheckYourBusinessNameIsCorrectBeforeSubmitting Page', async function () {
  await this.page.locator('//input[@id="business-name"]').clear()
  this.businessName = faker.company.name()
  await this.page.fill('//input[@id="business-name"]', this.businessName)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Given('Change the Business Name again in WhatIsYourBusinessName? Page', async function () {
  await this.page.locator('//input[@id="business-name"]').clear()
  this.businessName = faker.company.name()
  await this.page.fill('//input[@id="business-name"]', this.businessName)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Given('I update Business Address and click the Change link in CheckYourBusinessAddressIsCorrectBeforeSubmitting Page', async function () {
  await this.page.locator("//a[normalize-space()='Enter address manually']").click()
...
Given('Change the Business Address again in EnterYourBusinessAddress Page', async function () {
  this.addressline1 = faker.location.streetAddress()
  await this.page.locator('//input[@id="address-1"]').clear()
  await this.page.fill('//input[@id="address-1"]', this.addressline1)
...
Given('I update Business PhoneNumber and click the Change link in CheckYourBusinessPhoneNumbersAreCorrectBeforeSubmitting Page', async function () {
  await this.page.locator('[id="businessTelephone"]').clear()
  this.phonenumber = generateRandomPhoneNumber()
  await this.page.fill('#businessTelephone', this.phonenumber)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Given('Change the Business PhoneNumber again in WhatAreYourBusinessPhoneNumbers? Page', async function () {
  await this.page.locator('[id="businessTelephone"]').clear()
  this.phonenumber = generateRandomPhoneNumber()
  await this.page.fill('#businessTelephone', this.phonenumber)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Then('Verfiy Updated Business PhoneNumber details on the ViewAndUpdateYourBusinessType page are been displayed correctly', async function () {
  const actPhNum = await this.page
    .locator('//dt[normalize-space()="Business phone numbers"]/following-sibling::dd[1]/div[1]/span')
    .textContent()
  expect(actPhNum).toBe(this.phonenumber)
...
Given('I update Business EmailAddress and click the Change link in CheckYourBusinessEmailAddressIsCorrectBeforeSubmitting Page', async function () {
  await this.page.locator('//input[@id="business-email"]').clear()
  this.email = generateRandomEmail()
  await this.page.fill('//input[@id="business-email"]', this.email)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Given('Change the Business EmailAddress again in CheckYourBusinessEmailAddressIsCorrectBeforeSubmitting Page', async function () {
  await this.page.locator('//input[@id="business-email"]').clear()
  this.email = generateRandomEmail()
  await this.page.fill('//input[@id="business-email"]', this.email)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Then('Verfiy Updated Business EmailAddress details on the ViewAndUpdateYourBusinessType page are been displayed correctly', async function () {
  const actEmail = await this.page
    .locator("//dt[normalize-space()='Business email address']/following-sibling::dd[1]")
    .innerText()
  expect(actEmail).toBe(this.email)
...
Given('I enter the test data on the field {string} with value as {string} on the BusinessAddress page', async function (field, length) {
  await this.page.locator("//a[normalize-space()='Enter address manually']").click()
...
Then('Verfiy relevant ErrorMessage {string} is displayed', async function (errMsg) {
...
Given('I enter the test data on the field {string} with value as {string} on the {string} page', async function (field, length, _page) {
  this.generateValue = generateValidationTestData(field, length)
  ...
  switch (field.toLowerCase()) {
    ...
    case 'businessandmobilephone':
      ...
      await this.page.fill("//input[@id='businessMobile']", this.generateValue)
      await this.page.locator("//button[normalize-space()='Continue']").click()
      break
    ...
    case 'personalphone':
      ...
      await this.page.fill('//input[@id="personalTelephone"]', this.generateValue)
      await this.page.locator('//button[normalize-space()="Continue"]').click()
      break
    ...
    case 'personalandmobilephone':
      ...
      await this.page.fill('//input[@id="personalMobile"]', this.generateValue)
      await this.page.locator('//button[normalize-space()="Continue"]').click()
      break
...
Given('I click a link signIn link in LandAndFarmService page', async function () {
  await this.page.locator('a[href="/auth/sign-in"]').click()
})

Then('Application should Navigate to SignInToFarmingFrontDoor page.', async function () {
...
When('I click {string} link', async function (link) {
  switch (link.toLowerCase()) {
    case 'remove':
      await this.page.locator('//a[@href="/business-vat-registration-remove"]').click()
      break
    case 'change':
      await this.page.locator('//a[@href="/business-vat-registration-number-change"]').click()
      break
...
When('I click {string} button in the AreYouSureYouWantToRemoveYourVATRegistrationNumber page', async function (btnType) {
...
Given('I Update the VAT number in WhatIsYourVATRegistrationNumber page and submit', async function () {
  await this.page.locator('//input[@id="business-vat"]').clear()
...
Then('ViewAndUpdateYourBusinessType page should display updated VAT number', async function () {
  const actUpdatedVATnumber = await this.page
    .locator("//dt[normalize-space()='VAT registration number']/following-sibling::dd[1]")
    .innerText()
  expect(actUpdatedVATnumber).toBe('987654321')
})

When('I click the {string} link on the "ViewAndUpdateYourPersonalDetails"Page', async function (linkType) {
  switch (linkType.toLowerCase()) {
    case 'personalphonenumbers':
      await this.page.getByRole('link', { name: 'Personal phone numbers' }).click()
      break
    case 'fullname':
    ...
    case 'personaldob':
      ...
      break
    case 'personalemailaddress':
      await this.page.getByRole('link', { name: 'Personal email address' }).click()
      break
    default:
      throw new Error(`Unknown link type: ${linkType}`)
  }
...
Then('Verfiy updated phone details on the ViewAndUpdateYourPersonalDetails page are been displayed correctly', async function () {
...
Then('Verify Success Updated message is displayed for {string} on the page ViewAndUpdateYourPersonalDetails page', async function (linkType) {
  switch (linkType.toLowerCase()) {
    case 'personalphonenumbers': {
      const msg = await this.page.locator("//div[@class='govuk-notification-banner__content']").innerText()
...
Then('Verfiy Updated Personal Full Name details on the ViewAndUpdateYourPersonalDetails page are been displayed correctly', async function () {
  const actName = await this.page
    .locator("//dt[normalize-space()='Full name']/following-sibling::dd[1]")
    .innerText()
  expect(actName).toBe(`${this.firstName} ${this.middleName} ${this.lastName}`)
})

Given('I update Personal Name and click the Change link in CheckYourNameIsCorrectBeforeSubmitting page', async function () {
  await this.page.locator('//input[@id="first"]').clear()
  await this.page.locator('//input[@id="middle"]').clear()
  await this.page.locator('//input[@id="last"]').clear()
...
Given('Change the Personal Name again in WhatIsYourFullName? Page', async function () {
  await this.page.locator('//input[@id="first"]').clear()
  await this.page.locator('//input[@id="middle"]').clear()
  await this.page.locator('//input[@id="last"]').clear()
...
Given('I update Personal phone number and click the {string} in the CheckYourPersonalPhoneNumbersAreCorrectBeforeSubmitting page', async function (linkType) {
  await this.page.locator('[id="personalTelephone"]').clear()
  this.personalPhonenumber = generateRandomPhoneNumber()
  await this.page.fill('#personalTelephone', this.personalPhonenumber)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Then('Verify the previously entered details are still displayed in WhatAreYourPersonalPhoneNumbers? page', async function () {
  const acttelephoneNumber = await this.page.locator("//input[@id='personalTelephone']").inputValue()
...
Given('I update Personal Address Manually and click the Change link in CheckYourPersonalAddressIsCorrectBeforeSubmitting Page', async function () {
  await this.page.locator("//a[normalize-space()='Enter address manually']").click()
...
Given('Change the Personal Address Manually again in EnterYourPersonalAddress Page', async function () {
  this.addressline1 = faker.location.streetAddress()
  await this.page.locator('//input[@id="address1"]').clear()
  await this.page.fill('//input[@id="address1"]', this.addressline1)
...
Then('Verfiy updated Personal Address Manually changed details on the ViewAndUpdateYourPersonalDetails page are been displayed correctly', async function () {
  const actAddrLine1 = await this.page.locator("//dt[normalize-space()='Personal address']/following-sibling::dd[1]/div[1]").innerText()
  const actAddrLine2 = await this.page.locator("//dt[normalize-space()='Personal address']/following-sibling::dd[1]/div[2]").innerText()
  const actCity = await this.page.locator("//dt[normalize-space()='Personal address']/following-sibling::dd[1]/div[3]").innerText()
  const actPostcode = await this.page.locator("//dt[normalize-space()='Personal address']/following-sibling::dd[1]/div[4]").innerText()
  expect(actAddrLine1).toBe(this.addressline1)
  expect(actAddrLine2).toContain(this.addressline2)
  expect(actCity).toBe(this.city)
  expect(actPostcode).toContain(this.postcode)
...
Given('I enter the test data on the field {string} with value as {string} on the EnterYourPersonalAddress page', async function (field, length) {
  await this.page.locator("//a[normalize-space()='Enter address manually']").click()
...
Given('I enter the test data on with value as {string} on the WhatIsYourPersonalAddress page', async function (testData) {
  await this.page.locator("//input[@id='postcode']").clear()
...
Given('I update Personal DateOfBirth and click the {string} in the CheckYourDateOfBirthIsCorrectBeforeSubmitting page', async function (linkType) {
  const dob = faker.date.birthdate({ min: 18, max: 90, mode: 'age' })
...
Then('Verify the previously entered details are still displayed in WhatIsYourDateOfBirth? page', async function () {
  const actDayValue = await this.page.locator("//input[@id='day']").inputValue()
  const actMonthValue = await this.page.locator("//input[@id='month']").inputValue()
  const actYearValue = await this.page.locator("//input[@id='year']").inputValue()
  expect(actDayValue).toBe(this.day)
  expect(actMonthValue).toContain(this.month)
  expect(actYearValue).toBe(this.year)
})

Given('I enter the test data on the field {string} with value as {string} on the WhatIsYourFullName? page', async function (field, length) {
  this.firstName = faker.person.firstName()
  await this.page.locator('//input[@id="first"]').clear()
  await this.page.fill('//input[@id="first"]', this.firstName)
...
Then('Verfiy Updated Personal Email Address details on the ViewAndUpdateYourPersonalDetails page are been displayed correctly', async function () {
  const actEmail = await this.page
    .locator("//dt[normalize-space()='Personal email address']/following-sibling::dd[1]")
    .innerText()
  expect(actEmail).toBe(this.personalEmail)
})

Given('I update Personal email address and click the {string} in the CheckYourPersonalEmailAddressIsCorrectBeforeSubmitting page', async function (linkType) {
  await this.page.locator('//input[@id="personal-email"]').clear()
  this.personalEmail = generateRandomEmail()
  await this.page.fill('//input[@id="personal-email"]', this.personalEmail)
  await this.page.locator("//button[normalize-space()='Continue']").click()
...
Then('Verify the previously entered details are still displayed in WhatIsYourPersonalEmailAddress? page', async function () {
  const actPersonalEmail = await this.page.locator("//input[@id='personal-email']").inputValue()
  expect(actPersonalEmail).toBe(this.personalEmail)
})

Given('I enter the test data with value on the field Day {string} Month {string} and Year {string} On the WhatIsYourDateOfBirth page', async function (day, month, year) {
  await this.page.locator("//input[@id='day']").clear()
  await this.page.fill("//input[@id='day']", day)
  await this.page.locator("//input[@id='month']").clear()
  await this.page.fill("//input[@id='month']", month)
...
Then('The {string} change link should be {string}', async function (linkType, visible) {
  const shouldBeVisible = visible.toLowerCase() === 'yes'

  switch (linkType.toLowerCase()) {
    case 'businessaddress': {
      const count = await this.page.getByRole('link', { name: 'Change Business address' }).count()
      shouldBeVisible ? expect(count).toBeGreaterThan(0) : expect(count).toBe(0)
      break
    }
    case 'businessphonenumbers': {
      const count = await this.page.getByRole('link', { name: 'Change Business telephone numbers' }).count()
      shouldBeVisible ? expect(count).toBeGreaterThan(0) : expect(count).toBe(0)
      break
    }
    case 'businessemailaddress': {
      const count = await this.page.getByRole('link', { name: 'Change Business email address' }).count()
      shouldBeVisible ? expect(count).toBeGreaterThan(0) : expect(count).toBe(0)
      break
    }
    case 'businessname': {
      const count = await this.page.getByRole('link', { name: 'Change business name' }).count()
      shouldBeVisible ? expect(count).toBeGreaterThan(0) : expect(count).toBe(0)
      break
    }
    case 'businesslegalstatus': {
      const count = await this.page.getByRole('link', { name: 'Change business legal status' }).count()
      shouldBeVisible ? expect(count).toBeGreaterThan(0) : expect(count).toBe(0)
      break
    }
    case 'businesstype': {
      const count = await this.page.getByRole('link', { name: 'Change business type' }).count()
      shouldBeVisible ? expect(count).toBeGreaterThan(0) : expect(count).toBe(0)
      break
    }
    case 'vatnumber': {
      const count = await this.page.getByRole('link', { name: 'Change VAT registration number' }).count()
      shouldBeVisible ? expect(count).toBeGreaterThan(0) : expect(count).toBe(0)
      break
    }
    default:
...
Then('Verify relevant Permission message type for {string} is displayed on the page ViewAndUpdateYourBusinessType', async function (linkType) {
  switch (linkType.toLowerCase()) {
    case 'amendpermission': {
      ...
      expect(actMsg).toBe('You only have permission to update contact details for this business. You can ask the business to raise your permission level.')
      break
    }
    case 'viewpermission': {
      const actMsg = await this.page.locator("//p[@class='govuk-body']").innerText()
...
Given('I enter the test data on the Emailformat as {string} on the {string} page', async function (emailFormat, _page) {
  await this.page.locator('//input[@id="personal-email"]').clear()
  await this.page.fill('//input[@id="personal-email"]', emailFormat)
  await this.page.locator('//button[normalize-space()="Continue"]').click()
})

Given('Verify relevant Header for {string} is displayed on the ViewAndUpdateYourBusinessType Page', async function (linkType) {
  if (linkType.toLowerCase() === 'viewpermission') {
    const actMsg = await this.page.locator("//*[@id='main-content']//h1").innerText()
...
Then('Application should display with Message as {string}', async function (expMsg) {
  const actMsg = await this.page.locator('//*[@id="main-content"]//h1').innerText()
...
function getRandomUKPostcode() {
  const ukPostcodes = ['BT1 5GS', 'G1 2FF', 'CF10 1EP', 'LS1 4AP', 'M1 1AE', 'B1 1TB', 'NE1 4LP', 'NG1 5FS']
...
function generateRandomUKPostcode() {
  ...
  const patterns = [
    ...
    () => randomChar(allowedFirstLetters) + randomChar(allowedSecondLetters) + randomDigit(),
    () => randomChar(allowedFirstLetters) + randomChar(allowedSecondLetters) + randomDigit() + randomDigit(),
    () => randomChar(allowedFirstLetters) + randomDigit() + randomChar(allowedSecondLetters),
    () => randomChar(allowedFirstLetters) + randomChar(allowedSecondLetters) + randomDigit() + randomChar(allowedSecondLetters),
  ]
