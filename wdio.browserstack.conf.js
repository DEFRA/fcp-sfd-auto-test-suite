...
export const config = {
  ...
  baseUrl: `https://fcp-sfd-auto-test-suite.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `fcp-sfd-auto-test-suite-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `fcp-sfd-auto-test-suite-${process.env.ENVIRONMENT}`
        },
